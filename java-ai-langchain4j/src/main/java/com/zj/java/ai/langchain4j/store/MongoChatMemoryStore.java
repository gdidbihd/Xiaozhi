...
// Spring 只会给它自己创建的对象注入依赖。
// 自己 new 的对象，Spring 根本不管理它,会出现空指针异常
@Component
public class MongoChatMemoryStore implements ChatMemoryStore {
    ...
    public void updateMessages(Object memoryId, List<ChatMessage> list) {
        ...
        List<ChatMessage> cleanedList = ChatMessageCleaner.removeThinkBlocks(list);
        update.set("content", ChatMessageSerializer.messagesToJson(cleanedList));
